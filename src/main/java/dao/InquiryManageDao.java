...
public class InquiryManageDao {
	...
	public List<Inquiry> getInquiries(String category, String keyword) {
	    ...
	    StringBuilder sql = new StringBuilder(
	        "SELECT inquiry_number, email, name, inquiry_detail, inquiry_reply, create_date, update_date, category " +
	    ...
	    if (keyword != null && !keyword.isEmpty()) {
	        sql.append("AND (name LIKE ? OR email LIKE ? OR inquiry_detail LIKE ?) ");
	    }
