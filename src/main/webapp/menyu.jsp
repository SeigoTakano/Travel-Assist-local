...
<head>
    ...
    <title>Travel-Assist - PC Dashboard</title>
...
<body class="min-h-screen pb-32"> <!-- ボタンのスペースを確保 -->
    ...
    <main class="max-w-7xl mx-auto p-8 lg:p-12">
        <!-- Top Welcome Header -->
        <header class="mb-12">
            <h2 class="text-3xl font-bold text-slate-800">おかえりなさい！</h2>
            <p class="text-slate-500 mt-1">今日はどんな旅の計画を立てますか？</p>
        </header>

        <!-- Past Plans Section (作成済みプランなしの状態) -->
        <section class="mb-16">
        ...
        <section class="mb-16">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                <!-- Weather -->
                <button class="action-grid-btn bg-white p-10 rounded-3xl border border-slate-100 shadow-sm flex flex-col items-center hover:bg-orange-50 hover:border-orange-100 group">
                ...
                <!-- Transport -->
                <button class="action-grid-btn bg-white p-10 rounded-3xl border border-slate-100 shadow-sm flex flex-col items-center hover:bg-blue-50 hover:border-blue-100 group">
                ...
                <!-- Journey Log -->
                <button class="action-grid-btn bg-white p-10 rounded-3xl border border-slate-100 shadow-sm flex flex-col items-center hover:bg-green-50 hover:border-green-100 group">
                ...
                <!-- Route Search -->
                <button class="action-grid-btn bg-white p-10 rounded-3xl border border-slate-100 shadow-sm flex flex-col items-center hover:bg-purple-50 hover:border-purple-100 group">
    ...
    <div class="fixed bottom-0 left-0 right-0 p-6 bg-gradient-to-t from-slate-50 to-transparent pointer-events-none">
        <div class="max-w-7xl mx-auto flex justify-center pointer-events-auto">
            <button class="w-full md:w-auto md:min-w-[400px] bg-blue-600 text-white py-5 px-12 rounded-2xl font-bold text-xl flex items-center justify-center gap-3 shadow-2xl shadow-blue-200 hover:bg-blue-700 transition-all hover:scale-[1.02] active:scale-[0.98]">
